...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/home18',
      name: 'home18',
      component: () => import('@/views/Home18View.vue'),
    },
    {
      path: '/home19',
      name: 'home19',
      component: () => import('@/views/Home19View.vue'),
    },
    {
      path: '/home20',
      name: 'home20',
      component: () => import('@/views/Home20View.vue'),
    },
    {
      path: '/home21',
      name: 'home21',
      component: () => import('@/views/Home21View.vue'),
    },
    {
      path: '/home22',
      name: 'home22',
      component: () => import('@/views/Home22View.vue'),
    },
    {
      path: '/:pathMatch(.*)*',
      name: 'NotFound',
